...
sections:
  - type: markdown
    ...
    body: |
      ...
      **Data we collect:** Contact information provided when you contact us, register as a member, or submit a breach report. Website usage data collected via cookies (see below).
  ...
  - type: markdown
    ...
    body: |
      ...
      - Remember your acceptance of the development disclaimer (session storage, not a cookie)
      - Track basic analytics via privacy-respecting tools

      We do not use advertising cookies or share data with third parties for marketing purposes.
